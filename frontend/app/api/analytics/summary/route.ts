...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Analytics summary proxy failed.";
    return errorResponse(502, requestId, "Analytics summary proxy failed.", { error: message });
  }
}
