...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Analytics event proxy failed.";
    return errorResponse(502, requestId, "Analytics event proxy failed.", { error: message });
  }
}
